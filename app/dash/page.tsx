  ...
  return (
    <div className=" bg-slate-950 mx-auto w-full min-h-[calc(100svh-96px)]">
      ...
      <div className="flex flex-wrap md:gap-12 justify-center">
        <div className="overflow-hidden flex flex-col sm:w-64 w-full  bg-red-950 hover:bg-red-100 duration-100 transition-all rounded-md shadow-md  m-6">
          <Image
            src={fireIcon}
            alt={"What's Hot?"}
        ...
        <div className="overflow-hidden fill-white  flex flex-col sm:w-64 w-full bg-red-950 hover:bg-red-100 duration-100 transition-all rounded-md shadow-md  m-6">
          <Image
            src={listIcon}
            alt={"What's Hot?"}
